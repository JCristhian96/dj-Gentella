...
class Mark(TimeStampedModel):
    ...
    image = models.ImageField(upload_to="marks/",null=True, blank=True,verbose_name="Imagen")
...
class Product(TimeStampedModel):
    ...
    #umedida = models.CharField(max_length=2, choices=UMEDIDAS, verbose_name="Unidad de Medida")
